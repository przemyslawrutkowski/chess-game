...
import { PositionDTO } from '../../../shared/src/interfaces/DTO.js';
...
function setAttributes(svg: SVGElement, path: SVGPathElement, movementStrategy: MovementStrategy): void {
    ...
    } else if (movementStrategy === MovementStrategy.KingMovement) {
        svg.setAttribute('viewBox', '0 0 448 512');
...
function setColor(path: SVGPathElement, playerColor: PlayerColor): void {
    if (playerColor === PlayerColor.Light) path.classList.add('chess-piece-light');
