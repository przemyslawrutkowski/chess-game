...
export default function createChessPieceSVG(playerColor: PlayerColor, movementStrategy: MovementStrategy) {
    ...
    else if (playerColor === PlayerColor.Dark) path.classList.add('chess-piece-dark');
